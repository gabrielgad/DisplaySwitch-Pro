...
module WindowsAPI =
    ...
    module DISPLAYCONFIG_PATH =
        ...
        let DISPLAYCONFIG_PATH_MODE_IDX_INVALID = 0xFFFFFFFFu

    module DISPLAYCONFIG_MODE_INFO_TYPE =
        let DISPLAYCONFIG_MODE_INFO_TYPE_SOURCE = 1u
        let DISPLAYCONFIG_MODE_INFO_TYPE_TARGET = 2u
